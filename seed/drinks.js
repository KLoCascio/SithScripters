...
const main = async () => {
    const drink = [
        { name: 'Sith Surge', description: 'Feel a surge of power on your Darkest Days ... The real power is on the Dark Side', image: 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Aloe_vera_flower_inset.png' },
